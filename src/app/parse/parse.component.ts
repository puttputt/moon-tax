...
export class ParseComponent implements OnInit {
  ...
  private header = 'timestamp	corporation	pilot	oreType	quantity	volume	price';
  ...
  parse() {
    ...
    this.taxService.refineRate = +this.refineRate;
    this.taxService.allianceTax = +this.allianceTax;
    this.taxService.corporationTax = +this.corpTax;
